...
OBS: Funções Python que retornam valores, devem utilizar a 
palavra reservada return

OBS: Não precisamos necessariamente criar uma variavel para receber o retorno 
de uma função. Podemos passar a execução de uma função para outras funções.
...
1 - Ela finaliza a função, ou seja, ela sai da função;
2 - Podemos ter, em uma função, diferentes returns;
3 - Podemos em uma função retornar qualquer tipo de dado e até mesmo múltiplos valores;

#  Exemplo 1 - Ela finaliza a função, ou seja, ela sai da função;
